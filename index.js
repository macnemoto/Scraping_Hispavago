...
console.log(`Post esta Hubicado En el Tablon${board}`);
console.log(`Y es el numero :${thId}`);
const nekomaster = async () => {
  ...
  //Terminar parte del titulo cuando no esta 
...
//codigo para retaurar mas tarde
 console.log(nekomaster().then((res) => console.log("Listo Papacho Hay tiene tu post")));
